...
public class WebResourcesAllDisabledIT extends AbstractSeedWebIT {
    ...
    @Test
    @RunAsClient
    public void classpath_webresources_with_all_disabled_are_not_gzipped_nor_minified(
    ...
    @Test
    @RunAsClient
    public void docroot_webresources_with_all_disabled_are_not_gzipped_nor_minified(
            @ArquillianResource URL baseURL) throws Exception {
        expect().statusCode(200).header("Content-Encoding", not(equalTo("gzip"))).body(
