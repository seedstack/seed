...
public class WebResourcesGzipOnTheFlyDisabledIT extends AbstractSeedWebIT {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class).addAsResource("configuration/org.seedstack.seed.web.gzip-otf-disabled.properties", "META-INF/configuration/org.seedstack.seed.web.gzip-otf-disabled.properties").addAsWebResource("META-INF/resources/resources/test.js", "/resources/docroot-test.js").addAsWebResource("META-INF/resources/resources/test.js.gz", "/resources/docroot-test.js.gz").addAsWebResource("META-INF/resources/resources/test.min.js", "/resources/docroot-test.min.js").addAsWebResource("META-INF/resources/resources/test.min.js.gz", "/resources/docroot-test.min.js.gz").addAsWebResource("META-INF/resources/resources/test2.js", "/resources/docroot-test2.js");
    }
