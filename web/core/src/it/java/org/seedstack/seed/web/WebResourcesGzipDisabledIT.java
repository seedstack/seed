...
public class WebResourcesGzipDisabledIT extends AbstractSeedWebIT {
    ...
    @Test
    @RunAsClient
    public void classpath_webresources_with_gzip_disabled_are_minified_but_not_gzipped(
    ...
    @Test
    @RunAsClient
    public void docroot_webresources_with_gzip_disabled_are_minified_but_not_gzipped(
            @ArquillianResource URL baseURL) throws Exception {
        expect().statusCode(200).header("Content-Encoding", not(equalTo("gzip"))).body(
    ...
    @Test
    @RunAsClient
    public void classpath_webresources_with_gzip_disabled_are_not_gzipped_on_the_fly(
            @ArquillianResource URL baseURL) throws Exception {
        expect().statusCode(200).header("Content-Encoding", not(equalTo("gzip"))).body(
    ...
    @Test
    @RunAsClient
    public void docroot_webresources_with_gzip_disabled_are_not_gzipped_on_the_fly(
            @ArquillianResource URL baseURL) throws Exception {
        expect().statusCode(200).header("Content-Encoding", not(equalTo("gzip"))).body(
