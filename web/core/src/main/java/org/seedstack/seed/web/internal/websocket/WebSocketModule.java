...
class WebSocketModule extends AbstractModule {
    ...
    WebSocketModule(Set<Class<?>> serverEndpointClasses, Set<Class<? extends ServerEndpointConfig.Configurator>> serverConfiguratorClasses, Set<Class<?>> clientEndpointClasses, HashSet<Class<? extends ClientEndpointConfig.Configurator>> clientConfiguratorClasses) {
