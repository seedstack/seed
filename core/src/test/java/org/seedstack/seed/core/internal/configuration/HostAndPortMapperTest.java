...
public class HostAndPortMapperTest {
    ...
    public void testMapHostAndPort() throws NoSuchFieldException {
        assertThat((HostAndPort) (mapper.map(new ValueNode(SOME_HOST_4576), HostAndPort.class))).isEqualTo(HostAndPort.fromString(SOME_HOST_4576));
    }

    @Test
    public void testUnmapHostAndPort() throws Exception {
        assertThat(mapper.unmap(HostAndPort.fromString(SOME_HOST_4576), HostAndPort.class)).isEqualTo(new ValueNode(SOME_HOST_4576));
    }
}
