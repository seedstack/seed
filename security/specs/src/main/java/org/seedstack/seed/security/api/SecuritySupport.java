...
public interface SecuritySupport {
     ...
     * A {@link org.seedstack.seed.security.api.principals.SimplePrincipalProvider} is a name/value principal. A list of common SimplePrincipalProviders names are found in class
     ...
     * <br>
     * Note that it is discouraged to test for roles in your application as role names are prone to change in the life span of your application. To
     ...
     * @throws org.seedstack.seed.security.api.exceptions.AuthorizationException if the user does not have the given role.
     */
     ...
     * @throws org.seedstack.seed.security.api.exceptions.AuthorizationException if the user does not have all the given role.
     */
     ...
     * is called, the user is considered 'anonymous' and may continue to be used for another log-in if desired. <h3>Web Environment Warning</h3>
