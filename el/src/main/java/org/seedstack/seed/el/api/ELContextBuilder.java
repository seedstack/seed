...
public interface ELContextBuilder {
     ...
     * @return ELPropertyProvider
     * @throws org.seedstack.seed.core.api.SeedException if the context is null
     */
    ...
    public interface ELPropertyProvider {
         ...
         * @return ELPropertyProvider
         * @throws org.seedstack.seed.core.api.SeedException if the name is blank
         */
         ...
         * @return ELPropertyProvider
         * @throws org.seedstack.seed.core.api.SeedException if the localName is blank
         */
