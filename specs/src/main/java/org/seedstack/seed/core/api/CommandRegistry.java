...
public interface CommandRegistry {
     ...
     * @return the list of {@link org.seedstack.seed.core.spi.command.Option}.
     */
     ...
     * @param scope the command scope.
     * @param name the command name.
     * @return the list of {@link org.seedstack.seed.core.spi.command.Argument}.
     */
     ...
     * @param scope the command scope.
     * @param name the command name.
     * @return the {@link org.seedstack.seed.core.spi.command.CommandDefinition} object.
     */
    CommandDefinition getCommandInfo(String scope, String name);

    /**
     * Instantiate a {@link org.seedstack.seed.core.spi.command.Command} object given a scope, a name and a list of arguments and options.
     *
     * @param scope the command scope.
     * @param name the command name.
     ...
     *
     * @return the {@link org.seedstack.seed.core.spi.command.Command} object, already initialized and injected with corresponding values.
     */
