...
public class HalBuilderTest {
    ...
    public void build_hal_representation() {
        ...
        assertThat(halRep.getLinks().get("self").getHref()).isEqualTo("/orders");
        assertThat(halRep.getLinks().get("next").getHref()).isEqualTo("/orders?page=2");
        assertThat(halRep.getLinks().get("find").getHref()).isEqualTo("/orders{?id}");
        assertThat(halRep.getLinks().get("find").isTemplated()).isTrue();
        ...
        assertThat(halRep1.getLinks().get("self").getHref()).isEqualTo("/order/123");
        assertThat(halRep1.getLinks().get("basket").getHref()).isEqualTo("/baskets/98712");
        assertThat(halRep1.getLinks().get("customer").getHref()).isEqualTo("/customers/7809");
        ...
        assertThat(halRep2.getLinks().get("self").getHref()).isEqualTo("/order/124");
        assertThat(halRep2.getLinks().get("basket").getHref()).isEqualTo("/baskets/97213");
        assertThat(halRep2.getLinks().get("customer").getHref()).isEqualTo("/customers/12369");
