...
/**
 * Implementation of the {@link org.seedstack.seed.core.api.CommandRegistry}.
 *
...
class CommandRegistryImpl implements CommandRegistry {
    ...
    @Override
    public org.seedstack.seed.core.spi.command.CommandDefinition getCommandInfo(String scope, String name) {
        String qualifiedName = buildQualifiedName(scope, name);
