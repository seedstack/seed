...
public class SeedSecurityCoreModuleUnitTest {

    private SeedSecurityCoreModule underTest;
    ...
    public void testProvider() {
        SeedSecurityCoreModule.RealmProvider rp = new SeedSecurityCoreModule.RealmProvider();
